...
from schemas import PostResponse, UserCreate, UserPublic, UserPrivate , UserUpdate , Token , PaginatedPostsResponse , ForgotPasswordRequest , ResetPasswordRequest , ChangePasswordRequest
...
async def create_user(user:UserCreate , db: Annotated[AsyncSession , Depends(get_db)]):
    ...
    if existing_user:
        raise HTTPException(
            ...
            detail='usermame already exists',
        )
